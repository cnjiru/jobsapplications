...
<html lang="en">
  <head>
    ...
    <!-- Main Styles -->
    <link rel="stylesheet" href="{{ asset('css/green.css') }}" type="text/css">
        ...
        <section id="intro" class="section-intro">
          <div class="logo-menu">
            <nav class="navbar navbar-default" role="navigation" data-spy="affix" data-offset-top="50">
              <div class="container">
                ...
                <ul class="nav navbar-nav navbar-right float-right">
                  <li class="left"><a href="create"><i class="ti-pencil-alt"></i> Post A Job</a></li>
            ...
            <ul class="wpb-mobile-menu">
              ...
              <li class="btn-m"><a href="create"><i class="ti-pencil-alt"></i> Post A Job</a></li>
